...
impl BareMetalEditorIo {
    ...
    pub fn save(&mut self, handle: &DocumentHandle, content: &str) -> Result<String, EditorIoError> {
    ...
    pub fn save_as(&mut self, path: &str, content: &str) -> Result<(String, DocumentHandle), EditorIoError> {
